...
**Current version: 2.0.2** (24 abilities) — [Download zip](https://github.com/bucagdas/wp-mcp-bridges/releases/download/rank-math-mcp-ability-v2.0.2/rank-math-mcp-ability.zip) · [Changelog](https://github.com/bucagdas/wp-mcp-bridges/releases/tag/rank-math-mcp-ability-v2.0.2)
<!-- VERSION-LINE:END -->
...
1. Download [`rank-math-mcp-ability.zip`](https://github.com/bucagdas/wp-mcp-bridges/releases/download/rank-math-mcp-ability-v2.0.2/rank-math-mcp-ability.zip) (v2.0.2).
