...
**Current version: 1.4.1** (49 abilities) — [Download zip](https://github.com/bucagdas/wp-mcp-bridges/releases/download/generatepress-mcp-ability-v1.4.1/generatepress-mcp-ability.zip) · [Changelog](https://github.com/bucagdas/wp-mcp-bridges/releases/tag/generatepress-mcp-ability-v1.4.1)
<!-- VERSION-LINE:END -->
...
1. Download [`generatepress-mcp-ability.zip`](https://github.com/bucagdas/wp-mcp-bridges/releases/download/generatepress-mcp-ability-v1.4.1/generatepress-mcp-ability.zip) (v1.4.1).
