...
**Current version: 2.8.0** (32 abilities) — [Download zip](https://github.com/bucagdas/wp-mcp-bridges/releases/download/wc-mcp-ability-v2.8.0/wc-mcp-ability.zip) · [Changelog](https://github.com/bucagdas/wp-mcp-bridges/releases/tag/wc-mcp-ability-v2.8.0)
<!-- VERSION-LINE:END -->
...
1. Download [`wc-mcp-ability.zip`](https://github.com/bucagdas/wp-mcp-bridges/releases/download/wc-mcp-ability-v2.8.0/wc-mcp-ability.zip) (v2.8.0).
