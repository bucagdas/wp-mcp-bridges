...
**Current version: 1.0.5** (19 abilities) — [Download zip](https://github.com/bucagdas/wp-mcp-bridges/releases/download/contact-form-7-mcp-ability-v1.0.5/contact-form-7-mcp-ability.zip) · [Changelog](https://github.com/bucagdas/wp-mcp-bridges/releases/tag/contact-form-7-mcp-ability-v1.0.5)
<!-- VERSION-LINE:END -->
...
1. Download [`contact-form-7-mcp-ability.zip`](https://github.com/bucagdas/wp-mcp-bridges/releases/download/contact-form-7-mcp-ability-v1.0.5/contact-form-7-mcp-ability.zip) (v1.0.5).
